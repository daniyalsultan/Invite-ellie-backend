...
class FolderAdmin(admin.ModelAdmin):
    list_display = ('name', 'workspace', 'is_pinned', 'meeting_count', 'created_at')
    list_filter = ('is_pinned', 'created_at', 'workspace__owner')
...
class MeetingAdmin(admin.ModelAdmin):
    list_display = ('title', 'folder', 'status', 'duration', 'updated_at')
    list_filter = ('status', 'updated_at', 'folder__workspace__owner')
